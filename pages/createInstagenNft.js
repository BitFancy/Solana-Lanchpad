...
export default function CreateInstagenNft() {
  ...
  const mintInstagen = async () => {
    try {
      const transaction = await instagenContarct.mint(1,{gasLimit:"2099999"});
  ...
  const listItem = async (tokenId, price, forAuction,endTime) => {
    ...
    const transaction = await tradhubContract.listItem(
        InstaGenAddress,tokenId, price, 1,forAuction, endTime ,{gasLimit:'2099999'}
      );
 ...
 async function createMarket(e) { //store
    e.preventDefault();
    e.stopPropagation();
  ...
  useEffect(() => {
    const asyncFn = async () => {
      const hasCreatorRole = await accessMasterContarct.hasRole(await accessMasterContarct.FLOW_CREATOR_ROLE(), address)
        ...
        <div className="dark:bg-gray-800 kumbh text-center">
          ...
          {model && (
            <BuyAsset open={model} setOpen={setmodel} message={modelmsg} />
              ...
              <div className="flex justify-content-center" style={{gap:'50px'}}>
          <div className="p-5 overflow-y-scroll ...">
            ...
            >
                ...
                <div>
                  <div className="mt-5">
                    <div style={{textAlign:'initial'}}>Assets Name</div>
                    <input
                      required="required"
                    ...
                    <div className="mt-5">
                    <div style={{textAlign:'initial'}}>Assets Description</div>

                      <textarea
                        type="text"
                        placeholder="Asset Description"
                        className="w-full assets-input-back p-3"
                        onChange={(e) =>
                          updateFormInput({
                            ...formInput,
                      ...
                      >
                        <div className="flex justify-content-between ">
                          ...
                          <div >
                            ...
                            <i  onClose={handleClos} className="pi pi-times"></i>
             ...
             {toggleinput && (
              ...
              <input type="number" className="w-full p-2 assets-input-back"  placeholder="Asset Price in Matic"  onChange={(e) =>
                      updateFormInput({
                        ...formInput,
              ...
              {auctionToggle && (
                <div className="flex mt-3 gap-6 ">
                   ...
                   <InputNumber className="w-full p-2 assets-input-back" placeholder="Auction Duration"  inputId="expiry" suffix=" minutes" onValueChange={(e) =>
                      updateFormInput({
                        ...formInput,
