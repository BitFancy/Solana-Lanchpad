...
class SignatureSeries extends React.Component {
  ...
  onClickButton = () => {
    if (!this.state.contractName) {
      this.setState({
        contractNameEror: "Please Enter Drops Name",
      });
      return false;
    } else if (!this.state.contractSymbol) {
      this.setState({
        symbolError: "Please Enter Drops Symbol Descriptio",
      });
      return false;
  ...
  render() {
    return (
      <Layout2
        title="Deploy Drops"
        description="This is use to show information of the deploy Drops contract"
      >
        <Dialog
                  ...
                  {!this.state.signatureseriesRespoanse ? (
                    <>
                      <div id="addr0" className=" mt-5">
                        ...
                        <div className="mt-5">
                          <div className="text-left">Enter Drops Symbol</div>
