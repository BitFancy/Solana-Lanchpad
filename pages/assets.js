    ...
    <Layout title="Assets"description="This is used to create NFTs">
      <div className="body-back buy-back-image">
        <div className="dark:bg-gray-800 kumbh text-center">
          ...
          <div className="p-5 overflow-y-scroll ...">
            ...
            >
                ...
                />
                  ...
                  <div className="flex">
                    <div className="mt-5" style={{textAlign:'initial'}}>Upload File</div>
                  </div>
          ...
          <div className=" rounded-lg text-center p-3 border-2 border-indigo-600 ..." style={{height:"500px",width:'250px',marginTop:'80px'}}>
