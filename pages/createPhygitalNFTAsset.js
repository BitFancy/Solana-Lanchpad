...
function CreatePhygitalNFTAsset(props) {
                  ...
                  <div style={{ marginTop: "65px" }}>
                    ...
                    <div className="mt-5">
                      <div
                        ...
                        style={{ textAlign: "initial" }}
                      >
                        Phygital NFT Collection Asset Description
                      </div>
                      <div>
                        <textarea
                          type="text"
...
export default withRouter(CreatePhygitalNFTAsset);
