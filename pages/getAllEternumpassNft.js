...
export default function GetAllEternumpassNft() {
  ...
  const showError = () => {
    toast.current.show({
      severity: "error",
      summary: "Error",
      detail: "Error While getting data of the EternumPass EternumPass NFTs Data",
      life: 10000,
    });
  };
  useEffect(() => {
  ...
  return (
    <LayoutDashbord title="EternumPass NFts" description="Used to Show All EternumPass NFTs Details">
      <div>
            ...
            >
              {contractData?.length > 0 ? (
                contractData.map((contract) => {
                  return (
                    <Link key={1} href="/singleEternumpassNFT">
                ...
                <div className="text-2xl pb-10 font-bold text-center">
                  You haven&apos;t created any EternumPass NFts.
                </div>
              )}
            </div>
          </div>
