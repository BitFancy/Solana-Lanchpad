...
export default function AccessMasterRole() {
  ...
  return (
    <LayoutDashbord title="Access Master Role" description="Used to Show Access Master Role Information Details">
        <div>
        <MarketplaceProfileDetails/>
       
       
<div className={`${layoutConfig.colorScheme === 'light' ? 'buy-back-image-access' : 'dark'} flex justify-content-between `}>
<div >
<Sidemenu/>
</div>
<div style={{width:'100%'}}>
       ...
       <div style={{ width: "80%",margin:'0 auto' }}>
          <div className='font-bold text-3xl mt-5'>Manage Your Role</div>
            <div className=" p-5 card card-role mt-5">
              <div className='p-heading font-bold text-1xl'>1.  Grantrole</div>
            ...
            <div className=" p-5 card card-role">
              <div className='p-heading font-bold text-1xl'>2. Revokrole</div>
              <div className="mt-5 p-heading">Role</div>
              <div className="mt-2">
                <InputText
                  placeholder="Role"
